...
document.querySelector("#createdBy").innerHTML = "Aplicación creada por Nacho";
...
function displayToDos() {
  // Tu código acá:
  var todo = document.querySelector("#toDoContainer");   // 1

  todo.innerHTML = "";          // 2

  var array = buildToDos(toDoItems);      // 3
...
botoncito.addEventListener('click', addToDo)
